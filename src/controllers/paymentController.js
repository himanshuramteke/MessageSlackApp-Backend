...
export const capturePaymentController = async (req, res) => {
    try {
        ...
        await updatePaymentStatusService(req.body.orderId, req.body.status, req.body.payment, req.body.signature);
        ...
        console.log('Error in capturePayment controller', error);
        return res
            .status(StatusCodes.INTERNAL_SERVER_ERROR)
            .json(internalErrorResponse(error));
    }
